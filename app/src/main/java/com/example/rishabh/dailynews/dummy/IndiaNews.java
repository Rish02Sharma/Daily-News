...
public class IndiaNews extends Fragment
{
                             ...
                             Bundle savedInstanceState)
    {
        ...
        v = inflater.inflate(R.layout.fragment_indian, container, false);
        list=(ListView)v.findViewById(R.id.listindia);
        IndiaNews.NewsAsyncTask task = new IndiaNews.NewsAsyncTask();
        task.execute();
        return v;
    ...
    private class NewsAsyncTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            String result = null;
            try {
                URL url = new URL("https://newsapi.org/v1/articles?source=the-times-of-india&sortBy=top&apiKey=162d0b5797e94abb8327a5f6803ee767");
        ...
        private void extractFeatureFromJson(String earthquakeJSON) {
            try {
                ...
                IndiaNews.NewsAsyncTask.Adapterr adpt=new IndiaNews.NewsAsyncTask.Adapterr(getActivity(),NewsList);
