...
import static com.example.rishabh.dailynews.dummy.SportsNews.TAG_URLwebview;


public class WebSports extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pd = new ProgressDialog(WebSports.this);
