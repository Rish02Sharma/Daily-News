...
import static com.example.rishabh.dailynews.WorldNews.TAG_URLwebview;



public class InnerWebView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pd = new ProgressDialog(InnerWebView.this);
